...
public class ClassForAddTime {
    ...
    public ClassForAddTime(MyDate date) {
        this.date = date;
    }

    public void execute() {
        clientController.output("What do you want to add to the current date:");
    ...
    private void defineTypeValueOfDate(String s, long value) {
        switch (s) {
            case "1": {
                ...
                calendarService.addTime(date, finishValue);
            }
            ;
            break;
            case "2": {
            ...
            break;
            case "6": {
                calendarService.addTime(date, value);
            }
            ;
            break;
        }
