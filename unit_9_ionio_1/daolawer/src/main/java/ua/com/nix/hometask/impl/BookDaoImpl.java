...
public class BookDaoImpl implements BookDao {
    ...
    public void create(Book base) {
        ...
        try (CSVWriter writer = new CSVWriter(new FileWriter("db/src/main/java/ua/com/nix/hometask/books.csv"))) {
            if (booksData.size() < 1) {
                base.setId(1);
    ...
    private List<String[]> readFromBookCsv() {
        ...
        try (CSVReader reader = new CSVReader(new FileReader("db/src/main/java/ua/com/nix/hometask/books.csv"))) {
